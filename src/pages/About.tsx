  ...
  <>
    <section className="relative overflow-hidden bg-gradient-hero py-20">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="mb-4 text-4xl font-extrabold md:text-5xl text-gradient-hero">About NexivoLink</h1>
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
            Founded by Cynthia Chambless, NexivoLink is your trusted partner in finding the best connectivity solutions.
          </p>
        </motion.div>
      </div>
    </section>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <p className="mb-4 text-muted-foreground">
              NexivoLink was founded by <strong className="text-foreground">Cynthia Chambless</strong> with a simple mission: make it easier for people to find the right internet, TV, and streaming plans without the hassle.
            </p>
            <p className="mb-4 text-muted-foreground">
              After years of watching consumers struggle with confusing pricing, hidden fees, and aggressive sales tactics from providers, Cynthia built NexivoLink as an independent comparison service that puts customers first.
            </p>
            <p className="text-muted-foreground">
              Today, NexivoLink helps thousands of customers across 48 states compare plans from 50+ providers — all with a single phone call and zero pressure.
            </p>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
    ...
    <section className="bg-gradient-section py-20">
      <div className="container mx-auto px-4">
        <SectionHeading title="Our Values" subtitle="The principles that guide everything we do at NexivoLink." />
    ...
    <section className="bg-gradient-cta py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="mx-auto mb-8 max-w-xl text-primary-foreground/80">Talk to our team and experience the NexivoLink difference.</p>
