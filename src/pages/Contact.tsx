        ...
        <div className="grid gap-12 md:grid-cols-2">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+18886558557" className="text-primary font-semibold hover:underline">(888) 655-8557</a>
          ...
          <div className="rounded-xl border border-border bg-card p-8">
            ...
            <p className="mt-4 text-center text-xs text-muted-foreground">
              For the fastest response, call us at <a href="tel:+18886558557" className="text-primary font-semibold">(888) 655-8557</a>
            </p>
          </div>
        </div>
      </div>
