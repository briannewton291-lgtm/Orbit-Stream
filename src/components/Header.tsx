    ...
    <header className="sticky top-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <a href="tel:+18886558557" className="flex items-center gap-1.5 text-sm font-semibold text-primary">
            <Phone className="h-4 w-4" />
            (888) 655-8557
          </a>
          <Button asChild className="bg-accent text-accent-foreground hover:bg-accent/90">
            <a href="tel:+18886558557">Call Now</a>
          </Button>
        </div>
        ...
        <div className="border-t border-border/50 bg-background lg:hidden">
          <nav className="container mx-auto flex flex-col gap-1 px-4 py-4">
            ...
            <div className="mt-3 flex flex-col gap-2 border-t border-border/50 pt-3">
              <a href="tel:+18886558557" className="flex items-center gap-2 text-sm font-semibold text-primary">
                <Phone className="h-4 w-4" /> (888) 655-8557
              </a>
              <Button asChild className="bg-accent text-accent-foreground hover:bg-accent/90">
                <a href="tel:+18886558557">Call Now</a>
              </Button>
