    ...
    extend: {
      colors: {
        ...
        orbit: {
          ...
          orange: "hsl(var(--orbit-orange))",
          dark: "hsl(var(--orbit-dark))",
          navy: "hsl(var(--orbit-navy))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 15px hsl(176 88% 41% / 0.4)" },
          "50%": { boxShadow: "0 0 30px hsl(176 88% 41% / 0.7), 0 0 60px hsl(176 88% 41% / 0.3)" },
        },
        "blob-drift": {
